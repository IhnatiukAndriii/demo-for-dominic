  ...
  return (
    <section id="hero" className="relative overflow-hidden bg-gradient-to-br from-brand-orange-50 via-brand-cream/30 to-brand-orange-100">
      ...
      <div aria-hidden className="hidden lg:block">
        <div className="absolute top-[15%] left-[8%] w-16 h-16 rounded-full bg-white shadow-xl flex items-center justify-center text-3xl animate-float z-10 border border-brand-orange-100">
          {'\u{1F6D2}'}
        </div>
        <div className="absolute top-[12%] right-[8%] w-14 h-14 rounded-full bg-white shadow-xl flex items-center justify-center text-2xl animate-float-delayed z-10 border border-brand-orange-100">
          {'\u{2B50}'}
        </div>
        <div className="absolute bottom-[30%] left-[5%] w-14 h-14 rounded-full bg-white shadow-xl flex items-center justify-center text-2xl animate-float-slow z-10 border border-brand-orange-100">
          {'\u{1F4E6}'}
        </div>
        <div className="absolute bottom-[20%] left-[38%] w-16 h-16 rounded-full bg-white shadow-xl flex items-center justify-center text-3xl animate-float-delayed z-10 border border-brand-orange-100">
          {'\u{1F4AC}'}
        </div>
      </div>
            ...
            <div className="relative flex items-center max-w-full gap-0">
              ...
              <div className="relative z-20 -mr-12 flex-shrink-0 self-center hidden lg:block">
                <Image
                  ...
                  height={600}
                  priority
                  className="w-[360px] lg:w-[400px] h-auto"
                />
              </div>
